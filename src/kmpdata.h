...
static km_kpb_virtual_key const keycode_to_vk[256] = {
    ...
    KM_CORE_VKEY_BKSLASH, //        public static final int KEY_BACKSLASH = 0x2B;
    ...
    KM_CORE_VKEY_NPSTAR, //        public static final int KEY_KPASTERISK = 0x37;
    ...
    KM_CORE_VKEY__00, //        public static final int KEY_ZENKAKUHANKAKU = 0x55;
